...
bool vkFormatToGLFormat(VkFormat vkFormat, out TextureFormat tf)
{
    ...
    switch(vkFormat)
    {
        case VkFormat.VK_FORMAT_R8G8B8A8_UNORM, VkFormat.VK_FORMAT_R8G8B8A8_SRGB:
            tf.format = GL_RGBA;
            tf.internalFormat = GL_RGBA8;
            tf.pixelType = GL_UNSIGNED_BYTE;
            break;
        
        case VkFormat.VK_FORMAT_R8G8B8_UNORM, VkFormat.VK_FORMAT_R8G8B8_SRGB:
            tf.format = GL_RGB;
            tf.internalFormat = GL_RGB8;
            tf.pixelType = GL_UNSIGNED_BYTE;
            break;
        
        case VkFormat.VK_FORMAT_BC1_RGB_UNORM_BLOCK, VkFormat.VK_FORMAT_BC1_RGB_SRGB_BLOCK:
            tf.internalFormat = GL_COMPRESSED_RGB_S3TC_DXT1_EXT;
            tf.blockSize = 8;
            break;
        
        case VkFormat.VK_FORMAT_BC2_UNORM_BLOCK, VkFormat.VK_FORMAT_BC2_SRGB_BLOCK:
            tf.internalFormat = GL_COMPRESSED_RGBA_S3TC_DXT3_EXT;
            tf.blockSize = 16;
            break;
        
        case VkFormat.VK_FORMAT_BC3_UNORM_BLOCK, VkFormat.VK_FORMAT_BC3_SRGB_BLOCK:
